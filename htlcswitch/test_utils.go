...
func createTestChannel(alicePrivKey, bobPrivKey []byte,
	aliceAmount, bobAmount, aliceReserve, bobReserve eacutil.Amount,
	...
	*testLightningChannel, func(), error) {
	...
	aliceCommit := channeldb.ChannelCommitment{
		...
		CommitFee:     commitFee,
		FeePerKw:      eacutil.Amount(feePerKw),
...
func createClusterChannels(aliceToBob, bobToCarol eacutil.Amount) (
...
func createTwoClusterChannels(aliceToBob, bobToCarol eacutil.Amount) (
