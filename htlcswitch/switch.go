...
func (s *Switch) htlcForwarder() {
	...
	var (
		...
		totalSatSent    eacutil.Amount
		totalSatRecv    eacutil.Amount
	)
	...
	for {
		...
		case <-s.cfg.LogEventTicker.Ticks():
			...
			var (
				...
				newSatSent    eacutil.Amount
				newSatRecv    eacutil.Amount
			)
			...
			var (
				...
				diffSatSent    eacutil.Amount
				diffSatRecv    eacutil.Amount
			)
