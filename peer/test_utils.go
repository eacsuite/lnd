...
func (*mockWalletController) ConfirmedBalance(confs int32) (eacutil.Amount,
	error) {
...
func (m *mockWalletController) NewAddress(addrType lnwallet.AddressType,
	change bool) (eacutil.Address, error) {

	addr, _ := eacutil.NewAddressPubKey(
...
func (*mockWalletController) IsOurAddress(a eacutil.Address) bool {
	return false
}
...
func createTestPeer(notifier chainntnfs.ChainNotifier,
	...
	*Brontide, *lnwallet.LightningChannel, func(), error) {
	...
	channelCapacity := eacutil.Amount(10 * 1e8)
	channelBal := channelCapacity / 2
	aliceDustLimit := eacutil.Amount(200)
	bobDustLimit := eacutil.Amount(1300)
	...
	aliceCfg := channeldb.ChannelConfig{
		ChannelConstraints: channeldb.ChannelConstraints{
			...
			ChanReserve:      eacutil.Amount(rand.Int63()),
