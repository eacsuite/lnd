...
import (
	...
	"github.com/eacsuite/lnd/channeldb/migration_01_to_11/zpay32"
...
func MigrateInvoices(tx kvdb.RwTx) error {
	...
	eacNets := []*earthcoinCfg.Params{
		&earthcoinCfg.MainNetParams, &earthcoinCfg.SimNetParams,
		&earthcoinCfg.RegressionNetParams, &earthcoinCfg.TestNet4Params,
	}
	for _, net := range eacNets {
