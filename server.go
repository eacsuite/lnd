...
import (
	...
	sphinx "github.com/eacsuite/lightning-onion"
	"github.com/eacsuite/lnd/autopilot"
	"github.com/eacsuite/lnd/brontide"
	...
	"github.com/eacsuite/lnd/htlcswitch/hop"
	...
	"github.com/eacsuite/lnd/lnpeer"
	...
	"github.com/eacsuite/lnd/nat"
	"github.com/eacsuite/lnd/netann"
	"github.com/eacsuite/lnd/peer"
	"github.com/eacsuite/lnd/peernotifier"
	"github.com/eacsuite/lnd/pool"
	"github.com/eacsuite/lnd/queue"
	"github.com/eacsuite/lnd/routing"
	"github.com/eacsuite/lnd/routing/localchans"
	"github.com/eacsuite/lnd/routing/route"
	"github.com/eacsuite/lnd/sweep"
	"github.com/eacsuite/lnd/ticker"
	"github.com/eacsuite/lnd/tor"
	"github.com/eacsuite/lnd/walletunlocker"
	"github.com/eacsuite/lnd/watchtower/wtclient"
	"github.com/eacsuite/lnd/watchtower/wtdb"
	"github.com/eacsuite/lnd/watchtower/wtpolicy"
...
func newServer(cfg *Config, listenAddrs []net.Addr,
	...
	// Earthcoin, depending on the primary registered chain.
	...
	s.fundingMgr, err = newFundingManager(fundingConfig{
		...
		NumRequiredConfs: func(chanAmt eacutil.Amount,
			...
			// we consider it open.
			// TODO(halseth): Use Earthcoin params in case
			// of EAC channels.
		...
		RequiredRemoteDelay: func(chanAmt eacutil.Amount) uint16 {
			// We scale the remote CSV delay (the time the
			// remote have to claim funds in case of a unilateral
			// close) linearly from minRemoteDelay blocks
			// for small channels, to maxRemoteDelay blocks
			// for channels of size MaxFundingAmount.
			// TODO(halseth): Earthcoin parameter for EAC.
			...
			delay := uint16(eacutil.Amount(maxRemoteDelay) *
		...
		RequiredRemoteChanReserve: func(chanAmt,
			dustLimit eacutil.Amount) eacutil.Amount {
		...
		RequiredRemoteMaxValue: func(chanAmt eacutil.Amount) lnwire.MilliSatoshi {
		...
		RequiredRemoteMaxHTLCs: func(chanAmt eacutil.Amount) uint16 {
		...
		MinChanSize:                   eacutil.Amount(cfg.MinChanSize),
...
func (s *server) Start() error {
	...
	s.start.Do(func() {
		...
		if !s.cfg.NoNetBootstrap &&
			!(s.cfg.Bitcoin.SimNet || s.cfg.Earthcoin.SimNet) &&
			!(s.cfg.Bitcoin.RegTest || s.cfg.Earthcoin.RegTest) {
...
func initNetworkBootstrappers(s *server) ([]discovery.NetworkPeerBootstrapper, error) {
	...
	if !s.cfg.Bitcoin.SimNet || !s.cfg.Earthcoin.SimNet {
...
type openChanReq struct {
	...
	subtractFees    bool
	localFundingAmt eacutil.Amount
