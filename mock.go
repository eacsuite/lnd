...
func (*mockWalletController) FetchInputInfo(
	...
	utxo := &lnwallet.Utxo{
		...
		Value:         10 * eacutil.SatoshiPerBitcoin,
		PkScript:      []byte("dummy"),
		Confirmations: 1,
		OutPoint:      *prevOut,
	}
...
func (*mockWalletController) ConfirmedBalance(confs int32) (eacutil.Amount, error) {
	return 0, nil
}
...
func (m *mockWalletController) ListUnspentWitness(minconfirms,
	...
	utxo := &lnwallet.Utxo{
		AddressType: lnwallet.WitnessPubKey,
		Value:       eacutil.Amount(10 * eacutil.SatoshiPerBitcoin),
