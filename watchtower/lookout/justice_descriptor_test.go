...
import (
	...
	"github.com/eacsuite/lnd/watchtower/lookout"
	"github.com/eacsuite/lnd/watchtower/wtdb"
	"github.com/eacsuite/lnd/watchtower/wtmock"
...
func testJusticeDescriptor(t *testing.T, blobType blob.Type) {
	const (
		localAmount  = eacutil.Amount(100000)
		remoteAmount = eacutil.Amount(200000)
