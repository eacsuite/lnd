...
[eacsuite](https://github.com/eacsuite)) which is outlined on this page.
...
- Changes to publicly exported packages such as
  [brontide](https://github.com/eacsuite/lnd/tree/master/brontide) should
...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/eacsuite/lnd/blob/master/lntest/harness.go)
  contained within `lnd`. For example integration tests, see
  [`lnd_test.go`](https://github.com/eacsuite/lnd/blob/master/lnd_test.go#L181). 
...
[perusing the make file documentation](https://github.com/eacsuite/lnd/blob/master/docs/MAKEFILE.md).
...
described in [lnrpc README](https://github.com/eacsuite/lnd/blob/master/lnrpc/README.md)
...
definitions, check out the [lnrpc README](https://github.com/eacsuite/lnd/blob/master/lnrpc/README.md).
...
```
 go mod edit -replace=github.com/eacsuite/lightning-onion@v0.0.0-20180605012408-ac4d9da8f1d6=github.com/roasbeef/lightning-onion@2e5ae87696046298365ab43bcd1cf3a7a1d69695
```
...
Rejoice as you will now be listed as a [contributor](https://github.com/eacsuite/lnd/graphs/contributors)!
...
[MIT license](https://github.com/eacsuite/lnd/blob/master/LICENSE). This is
...
contribution](https://github.com/eacsuite/btcd/blob/master/docs/code_contribution_guidelines.md)
guidelines for btcd.
