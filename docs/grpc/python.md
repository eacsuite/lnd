...
5. Copy the lnd rpc.proto file (you'll find this at
  [lnrpc/rpc.proto](https://github.com/eacsuite/lnd/blob/master/lnrpc/rpc.proto))
  or just download it
    ```
    (lnd)$ curl -o rpc.proto -s https://raw.githubusercontent.com/eacsuite/lnd/master/lnrpc/rpc.proto
    ```
