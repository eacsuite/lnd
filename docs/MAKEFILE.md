...
The command `make check` requires `earthcoind` (almost any version should do) to
...
- Compilation and installation of `eacd` and `eacctl`.
...
`eacd`
------
Ensures that the [`github.com/eacsuite/eacd`][eacd] repository is checked out
locally. Lastly, installs the version of 
[`github.com/eacsuite/eacd`][eacd] specified in `Gopkg.toml`
...
`check`
-------
Installs the version of [`github.com/eacsuite/eacd`][eacd] specified
...
`itest`
-------
Installs the version of [`github.com/eacsuite/eacd`][eacd] specified in
...
Equivalent to [`lint`](#lint) [`eacd`](#eacd)
[`unit-race`](#unit-race).
...
[eacd]: https://github.com/eacsuite/eacd (github.com/eacsuite/eacd")
