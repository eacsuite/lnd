...
```
$ go-fuzz-build github.com/eacsuite/lnd/lnwire/<folder name here>
```
* Now, run `go-fuzz`!!!
```
...
this earlier, `go-fuzz` found two bugs ([#310](https://github.com/eacsuite/lnd/pull/310) and [#312](https://github.com/eacsuite/lnd/pull/312)) within minutes!
