...
const (
	...
	// CoinTypeEarthcoin specifies the BIP44 coin type for Earthcoin key
	// derivation.
	CoinTypeEarthcoin = 2
)
...
// interfaces backed by eacwallet's internal root waddrmgr. Internally, we'll
...
type BtcWalletKeyRing struct {
	// wallet is a pointer to the active instance of the eacwallet core.
...
// keychain.SecretKeyRing interface backed by eacwallet.
//
