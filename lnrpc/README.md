...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/eacsuite/lnd/lnrpc)
...
```bash
$ go get -u github.com/eacsuite/lnd/lnrpc
```
...
5. Run [`gen_protos.sh`](https://github.com/eacsuite/lnd/blob/master/lnrpc/gen_protos.sh)
