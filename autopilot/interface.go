...
type ChannelController interface {
	...
	OpenChannel(target *btcec.PublicKey, amt eacutil.Amount) error
	...
	// should be returned.
	SpliceIn(chanPoint *wire.OutPoint, amt eacutil.Amount) (*Channel, error)
	...
	SpliceOut(chanPoint *wire.OutPoint, amt eacutil.Amount) (*Channel, error)
}
