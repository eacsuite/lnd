...
type AgentConstraints interface {
	...
	ChannelBudget(chans []Channel, balance eacutil.Amount) (
		eacutil.Amount, uint32)
...
func NewConstraints(minChanSize, maxChanSize eacutil.Amount, chanLimit,
...
func (h *agentConstraints) ChannelBudget(channels []Channel,
	funds eacutil.Amount) (eacutil.Amount, uint32) {
	...
	var totalChanAllocation eacutil.Amount
	...
	targetAllocation := eacutil.Amount(float64(totalFunds) * h.allocation)
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MinChanSize() eacutil.Amount {
...
//
// Note: part of the AgentConstraints interface.
func (h *agentConstraints) MaxChanSize() eacutil.Amount {
