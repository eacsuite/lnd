...
[In this PR](https://github.com/eacsuite/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/eacsuite/lnd/aezeed
...
PASS
ok      github.com/eacsuite/lnd/aezeed  4.168s
```
