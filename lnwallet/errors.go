...
func ErrChanReserveTooSmall(reserve, dustLimit eacutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanReserveTooLarge(reserve,
	maxReserve eacutil.Amount) ReservationError {
	return ReservationError{
...
func ErrChanTooSmall(chanSize, minChanSize eacutil.Amount) ReservationError {
	return ReservationError{
