...
const anchorSize = eacutil.Amount(330)
...
func HtlcTimeoutFee(chanType channeldb.ChannelType,
	feePerKw chainfee.SatPerKWeight) eacutil.Amount {
...
func CreateCommitTx(chanType channeldb.ChannelType,
	...
	amountToLocal, amountToRemote eacutil.Amount,
