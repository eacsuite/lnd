...
type testContext struct {
	...
	fundingTx *eacutil.Tx

	localCsvDelay uint16
	fundingAmount eacutil.Amount
...
func testSpendValidation(t *testing.T, tweakless bool) {
	...
	const channelBalance = eacutil.Amount(1 * 10e8)
	const csvTimeout = 5
...
func createTestChannelsForVectors(tc *testContext, chanType channeldb.ChannelType,
	feeRate eacutil.Amount, remoteBalance, localBalance eacutil.Amount) (
