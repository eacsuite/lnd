...
func (i *PsbtIntent) FundingParams() (eacutil.Address, int64, *psbt.Packet,
	error) {
	...
	addr, err := eacutil.NewAddressWitnessScriptHash(
...
// creating a new one.
func NewPsbtAssembler(fundingAmt eacutil.Amount, basePsbt *psbt.Packet,
