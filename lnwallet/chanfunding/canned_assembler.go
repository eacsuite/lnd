...
//
// NOTE: This method satisfies the chanfunding.Intent interface.
func (s *ShimIntent) LocalFundingAmt() eacutil.Amount {
...
//
// NOTE: This method satisfies the chanfunding.Intent interface.
func (s *ShimIntent) RemoteFundingAmt() eacutil.Amount {
...
func NewCannedAssembler(thawHeight uint32, chanPoint wire.OutPoint,
	fundingAmt eacutil.Amount, localKey *keychain.KeyDescriptor,
