...
type ChanCloser struct {
	...
	lastFeeProposal eacutil.Amount
	...
	priorFeeOffers map[eacutil.Amount]*lnwire.ClosingSigned
...
func NewChanCloser(cfg ChanCloseCfg, deliveryScript []byte,
	...
	return &ChanCloser{
		...
		priorFeeOffers:      make(map[eacutil.Amount]*lnwire.ClosingSigned),
...
// compromise fee.
func (c *ChanCloser) proposeCloseSigned(fee eacutil.Amount) (*lnwire.ClosingSigned, error) {
...
func feeInAcceptableRange(localFee, remoteFee eacutil.Amount) bool {
...
// our offered fee.
func ratchetFee(fee eacutil.Amount, up bool) eacutil.Amount {
...
func calcCompromiseFee(chanPoint wire.OutPoint, ourIdealFee, lastSentFee,
	remoteFee eacutil.Amount) eacutil.Amount {
