...
import (
	...
	"github.com/eacsuite/lnd/lnwallet/chanvalidate"
	"github.com/eacsuite/lnd/lnwire"
	"github.com/eacsuite/lnd/shachain"
...
type InitFundingReserveMsg struct {
	...
	// to this channel.
	RemoteFundingAmt eacutil.Amount
...
//
// NOTE: At the moment the wallet requires a eacd full node, as it's dependent
// on eacd's websockets notifications as event triggers during the lifetime of a
...
// at all, as SPV support is integrated into eacwallet.
...
func (l *LightningWallet) ConfirmedBalance(confs int32) (eacutil.Amount, error) {
...
// version of the commitment transaction.
func CreateCommitmentTxns(localBalance, remoteBalance eacutil.Amount,
	...
	*wire.MsgTx, *wire.MsgTx, error) {
	...
	otxn := eacutil.NewTx(ourCommitTx)
	...
	ttxn := eacutil.NewTx(theirCommitTx)
