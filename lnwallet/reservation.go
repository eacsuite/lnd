...
func NewChannelReservation(capacity, localFundingAmt eacutil.Amount,
	...
	return &ChannelReservation{
		...
		partialState: &channeldb.OpenChannel{
			...
			LocalCommitment: channeldb.ChannelCommitment{
				...
				FeePerKw:      eacutil.Amount(commitFeePerKw),
				CommitFee:     commitFee,
			},
...
func (r *ChannelReservation) Capacity() eacutil.Amount {
	r.RLock()
	defer r.RUnlock()
