...
// such as: uspv, eacwallet, Bitcoin Core, Electrum, etc. This interface then
...
type WalletController interface {
	...
	ConfirmedBalance(confs int32) (eacutil.Amount, error)
	...
	// p2wsh, etc.
	NewAddress(addrType AddressType, change bool) (eacutil.Address, error)
	...
	LastUnusedAddress(addrType AddressType) (eacutil.Address, error)

	// IsOurAddress checks if the passed address belongs to this wallet
	IsOurAddress(a eacutil.Address) bool
	...
	// which could be e.g. eacd, bitcoind, neutrino, or another consensus
	// service.
	BackEnd() string
}
...
type WalletDriver struct {
	...
	// wallet driver. This could be e.g. bitcoind, eacd, neutrino, etc.
