...
var (
	...
	// Dummy timeout tx used to test serialization, borrowed from eacd
	// msgtx_test
...
func assertNurseryReport(t *testing.T, nursery *utxoNursery,
	...
	expectedLimboBalance eacutil.Amount) {
